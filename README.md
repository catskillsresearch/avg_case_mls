...
The source report is https://cs.nyu.edu/media/publications/TR1995-711.pdf (cached in repo as [`TR1995-711.pdf`](TR1995-711.pdf)); the new paper is [`arxiv.md`](arxiv.md).
